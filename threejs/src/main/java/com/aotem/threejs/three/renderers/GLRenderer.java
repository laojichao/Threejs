...
import com.aotem.threejs.three.cameras.ArrayCamera;
...
import com.aotem.threejs.three.core.Event;
import com.aotem.threejs.three.core.IListener;
import com.aotem.threejs.three.core.InstancedBufferAttribute;
...
import com.aotem.threejs.three.lights.Light;
import com.aotem.threejs.three.materials.LineBasicMaterial;
import com.aotem.threejs.three.materials.LineDashedMaterial;
import com.aotem.threejs.three.materials.Material;
import com.aotem.threejs.three.materials.MeshBasicMaterial;
import com.aotem.threejs.three.materials.MeshDepthMaterial;
import com.aotem.threejs.three.materials.MeshDistanceMaterial;
import com.aotem.threejs.three.materials.MeshLambertMaterial;
import com.aotem.threejs.three.materials.MeshMatcapMaterial;
import com.aotem.threejs.three.materials.MeshNormalMaterial;
import com.aotem.threejs.three.materials.MeshPhongMaterial;
import com.aotem.threejs.three.materials.MeshPhysicalMaterial;
import com.aotem.threejs.three.materials.MeshStandardMaterial;
import com.aotem.threejs.three.materials.MeshToonMaterial;
import com.aotem.threejs.three.materials.PointsMaterial;
import com.aotem.threejs.three.materials.RawShaderMaterial;
import com.aotem.threejs.three.materials.ShaderMaterial;
import com.aotem.threejs.three.materials.ShadowMaterial;
import com.aotem.threejs.three.materials.SpriteMaterial;
import com.aotem.threejs.three.math.Color;
import com.aotem.threejs.three.math.Frustum;
import com.aotem.threejs.three.math.Matrix4;
import com.aotem.threejs.three.math.Plane;
...
import com.aotem.threejs.three.objects.Bone;
import com.aotem.threejs.three.objects.Group;
import com.aotem.threejs.three.objects.GroupItem;
import com.aotem.threejs.three.objects.ImmediateRenderObject;
import com.aotem.threejs.three.objects.InstancedMesh;
import com.aotem.threejs.three.objects.LOD;
import com.aotem.threejs.three.objects.Line;
import com.aotem.threejs.three.objects.LineLoop;
import com.aotem.threejs.three.objects.LineSegments;
import com.aotem.threejs.three.objects.Mesh;
import com.aotem.threejs.three.objects.Points;
import com.aotem.threejs.three.objects.Skeleton;
import com.aotem.threejs.three.objects.SkinnedMesh;
import com.aotem.threejs.three.objects.Sprite;
import com.aotem.threejs.three.renderers.gl.GLAttributes;
import com.aotem.threejs.three.renderers.gl.GLBackground;
import com.aotem.threejs.three.renderers.gl.GLBufferRenderer;
import com.aotem.threejs.three.renderers.gl.GLCapabilities;
import com.aotem.threejs.three.renderers.gl.GLClipping;
import com.aotem.threejs.three.renderers.gl.GLGeometries;
import com.aotem.threejs.three.renderers.gl.GLIndexedBufferRenderer;
import com.aotem.threejs.three.renderers.gl.GLInfo;
import com.aotem.threejs.three.renderers.gl.GLLights;
import com.aotem.threejs.three.renderers.gl.GLMorphtargets;
import com.aotem.threejs.three.renderers.gl.GLObjects;
import com.aotem.threejs.three.renderers.gl.GLProgram;
import com.aotem.threejs.three.renderers.gl.GLPrograms;
import com.aotem.threejs.three.renderers.gl.GLProperties;
import com.aotem.threejs.three.renderers.gl.GLRenderLists;
import com.aotem.threejs.three.renderers.gl.GLRenderStates;
import com.aotem.threejs.three.renderers.gl.GLShadowMap;
import com.aotem.threejs.three.renderers.gl.GLState;
import com.aotem.threejs.three.renderers.gl.GLTextures;
import com.aotem.threejs.three.renderers.gl.GLUniforms;
import com.aotem.threejs.three.renderers.gl.GLUtils;
import com.aotem.threejs.three.renderers.gl.uniform.Uniform;
import com.aotem.threejs.three.renderers.shaders.ShaderLib;
import com.aotem.threejs.three.renderers.shaders.UniformsLib;
import com.aotem.threejs.three.scenes.Fog;
import com.aotem.threejs.three.scenes.FogExp2;
import com.aotem.threejs.three.scenes.Scene;
import com.aotem.threejs.three.textures.CubeTexture;
import com.aotem.threejs.three.textures.DataTexture;
import com.aotem.threejs.three.textures.Texture;

import static com.aotem.threejs.three.constant.Constants.BackSide;
...
import static com.aotem.threejs.three.constant.Constants.LinearToneMapping;
import static com.aotem.threejs.three.constant.Constants.RGBAFormat;
import static com.aotem.threejs.three.constant.Constants.TriangleFanDrawMode;
import static com.aotem.threejs.three.constant.Constants.TriangleStripDrawMode;
import static com.aotem.threejs.three.constant.Constants.TrianglesDrawMode;
...
public class GLRenderer {
    ...
    public void initMaterial(Material material, Fog fog, Object3D object) {
        ...
        if ( ! (material instanceof ShaderMaterial) &&
            ...
            uniforms.put("clippingPlanesNecom.aotem.threejspdate", _clipping.uniformNeedsUpdate);
        }
